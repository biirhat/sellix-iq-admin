...
const ThemeCircle: React.FC<{
  ...
  return (
    <Pressable onPress={onPress} className="items-center" style={{ marginTop: 0 }}>
  ...
  return (
    <KeyboardAwareScrollView
      ...
      contentContainerStyle={{
        paddingTop: 0, // rely on SafeAreaView to provide header/safe-area spacing
        paddingBottom: 12,
      }}
      bottomOffset={60}
    >
      <SafeAreaView className="flex-row justify-around">
